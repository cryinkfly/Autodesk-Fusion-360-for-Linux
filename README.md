...
- The script fails silently on some Linux distributions if „dialog" isn't installed!
- Some packages (dialog, p7zip, p7zip-full, p7zip-rar, curl, wget, winbind, cabextract, wine, wine-mono, wine_gecko & winetricks)
