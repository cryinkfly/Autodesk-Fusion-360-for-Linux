...
Autodesk Fusion 360 è un software cloud-based di modellazione 3D, CAD, CAM e PCB per il design e la produzione del prodotto, utilizzabile su macOS e Windows.

Il problema è che ci sono anche persone come me che non vogliono utilizzare nessuno di questi due sistemi operativi sul loro PC, i quali gradirebbero utilizzare distribuzioni Linuc quali openSUSE Leap, Ubuntu o Fedora.

Così ho avuto l'idea di iniziare questo progetto per trovare il modo do risolvere questo problema. 

Ho cominciato a prendere in considerazione vari tools e la mia scelta è ricaduta su Wine! 

Con questo comodo strumento, non vi è più bisogno di utilizzare due sistemi operativi per poter utilizzare Fusion 360.

---

Puoi trovare maggiori informazioni su questa applicazione visitando il sito ufficiale di Autodesk Fusion 360 a questo link: https://www.autodesk.com/products/fusion-360/features

---

## Versione corrente di Autodesk Fusion 360

**Numero versione:** 2.0.12157*

*Nota: [Come posso verificare quale versione di Fusion 360 sto utilizzando?](https://knowledge.autodesk.com/support/fusion-360/troubleshooting/caas/sfdcarticles/sfdcarticles/How-to-check-what-version-of-Fusion-360-is-installed.html)
...
<a href="https://github.com/cryinkfly/Autodesk-Fusion-360-for-Linux/tree/main/files/scripts/stable-branch">Stable</a> and <a href="https://github.com/cryinkfly/Autodesk-Fusion-360-for-Linux/tree/main/files/scripts/development-branch">development builds</a>
  - 📔 Documentazione: <a href="https://github.com/cryinkfly/Fusion-360---Linux-Wine-Version-/wiki/Documentation">Documentazione GitHub</a> & <a href="https://www.youtube.com/watch?v=-BktJspJKgs&list=PLzwMdS5iu_BIsO6RTy7Hy1MbzLMrQE2xe">Video</a>
  - 💬 Voresti scrivermi o hai domande, problemi o suggerimenti?
  - 📫 Puoi creare un <a href="https://github.com/cryinkfly/Fusion-360---Linux-Wine-Version-/issues">ticket</a> qui su GitHub oppure puoi trovarmi al mio <a href="https://cryinkfly.com">sito</a>!
  - 📜 Codice di condotta: [Contributor Covenant](https://github.com/cryinkfly/Fusion-360---Linux-Wine-Version-/blob/main/.github/CODE_OF_CONDUCT.md)
  - 📖 Informazioni per i contributors: All contribution information, Compilation instructions, Roadmap (Still in Progress!)
...
Ci sono alcuni <a href="https://github.com/cryinkfly/Autodesk-Fusion-360-for-Linux/tree/main/files/scripts">script rilasciati</a> disponibili, creati dai release targets.

Se sei nuovo ti consiglio di iniziare con le release stabili. Le release di sviluppo sono disponibili se ti servono, ma possono essere beno stabili.

Nella [development branch](https://github.com/cryinkfly/Autodesk-Fusion-360-for-Linux/tree/main/files/scripts/development-branch) troverai, ad esempio, le prossime versioni del mio wizard di setup, insieme ai pacchetti che utilizzano Flatpak o Docker.

---

## Requisiti di sistema

- Connessione internet (20mbps+ raccomandati)!
- Driver grafici più recenti, vedi <a href="https://github.com/cryinkfly/Fusion-360---Linux-Wine-Version-/wiki/Supported-Graphics-Cards">qui</a>!
...
Installare il client di Fusion 360 su Linux:
...
## Funzioni e aree di lavoro testate e funzionanti:
...
<tr>
<td>Supporto per le lingue</td>
<td style="text-align: center;"><g-emoji class="g-emoji" alias="heavy_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2714.png"><img class="emoji" alt="heavy_check_mark" src="https://github.githubassets.com/images/icons/emoji/unicode/2714.png" width="20" height="20"></g-emoji></td>
<td style="text-align: center;"><g-emoji class="g-emoji" alias="heavy_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2714.png"><img class="emoji" alt="heavy_check_mark" src="https://github.githubassets.com/images/icons/emoji/unicode/2714.png" width="20" height="20"></g-emoji></td>
<td style="text-align: center;"><g-emoji class="g-emoji" alias="heavy_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2714.png"><img class="emoji" alt="heavy_check_mark" src="https://github.githubassets.com/images/icons/emoji/unicode/2714.png" width="20" height="20"></g-emoji></td>
</tr>
<tr>
<td><a href="https://github.com/cryinkfly/Autodesk-Fusion-360-for-Linux/tree/main/files/docs/en-US/extensions">Script e moduli addizionali</a></td>
<td style="text-align: center;"><g-emoji class="g-emoji" alias="heavy_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2714.png"><img class="emoji" alt="heavy_check_mark" src="https://github.githubassets.com/images/icons/emoji/unicode/2714.png" width="20" height="20"></g-emoji></td>
<td style="text-align: center;"><g-emoji class="g-emoji" alias="heavy_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2714.png"><img class="emoji" alt="heavy_check_mark" src="https://github.githubassets.com/images/icons/emoji/unicode/2714.png" width="20" height="20"></g-emoji></td>
<td style="text-align: center;"><g-emoji class="g-emoji" alias="heavy_check_mark" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2714.png"><img class="emoji" alt="heavy_check_mark" src="https://github.githubassets.com/images/icons/emoji/unicode/2714.png" width="20" height="20"></g-emoji></td>
</tr>
...
## Nota Importante
Con il mio script, puoi installare Fusion 360 sul tuo sistema Linux. 

Alcuni pacchetti e programmi richiesti saranno impostati per te, è importante però ricordare che è l'unica cosa che il mio script fa! 

Per questo, sarà necessario possedere una licenza di utilizzo valida per il software, che potrai comprare direttamente dal produttore del software Autodesk Fusion 360!

---

## Licenza

Tutti i miei script sono rilasciati sotto la licenza MIT: vedi <a href="https://github.com/cryinkfly/Fusion-360---Linux-Wine-Version-/blob/main/LICENSE.md">LICENSE.md</a> per il testo completo.
