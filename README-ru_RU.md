<div id="fusion360-about" align="center">
 ...
 🌍 Официальный участник: <a href="https://github.com/cryinkfly/Autodesk-Fusion-360-for-Linux/releases/tag/v5.1">Autodesk Group Network</a> & <a href= "https://feedback.autodesk.com/key/Fusion360Insider">Программа предварительной оценки Autodesk Fusion 360</a>! 🌍
 </br>
    ...
    <tr>
     ...
     <u>Дистрибутивы Linux</u>
      <ul>
       ...
       <li><p>Debian 10, MX Linux 19.4, Raspbian, ...</p></li>
       <li><p>Дебиан 11</p></li>
       <li><p>Fedora 35</p></li>
       <li><p>Fedora 36</p></li>
...
Если вы считаете, что с этим проектом или его документацией что-то не так, <a href="https://cryinkfly.com/become-partners/">помочь</a> каким-либо образом сделать это лучше, чем просто жаловаться на это - в конце концов, это проект с открытым исходным кодом! 🎈
 </br></br>
