...
function check_option() {
    case "$1" in
        ...
        "install_part5")
            ...
            WINEPREFIX="$selected_directory/wineprefixes/default" wineboot -k
            sleep 5
            ;;
        *)
...
function wine_fusion360_config() {
    ...
    mkdir -p "$selected_directory/drive_c/users/$USER/AppData/Roaming/Autodesk/Neutron Platform/Options"
    cd "$selected_directory/drive_c/users/$USER/AppData/Roaming/Autodesk/Neutron Platform/Options" || return
    dxvk_opengl_2
    mkdir -p "$selected_directory/drive_c/users/$USER/AppData/Local/Autodesk/Neutron Platform/Options"
    cd "$selected_directory/drive_c/users/$USER/AppData/Local/Autodesk/Neutron Platform/Options" || return
    dxvk_opengl_2
    mkdir -p "$selected_directory/drive_c/users/$USER/Application Data/Autodesk/Neutron Platform/Options"
    cd "$selected_directory/drive_c/users/$USER/Application Data/Autodesk/Neutron Platform/Options" || return
    dxvk_opengl_2
